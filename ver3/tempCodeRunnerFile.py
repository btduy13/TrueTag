...
if hasattr(sys, '_MEIPASS'):
    ...
    PID_SCRIPTS_FOLDER = r"C:\Users\USER\Desktop\Auto App\Tổng hợp\PID"  # Base folder path for VSP
    TML_SCRIPTS_FOLDER = r"C:\Users\USER\Desktop\Auto App\Tổng hợp\TML"  # Base folder path for VSP
    POSITION_SCRIPTS_FOLDER = r"C:\Users\USER\Desktop\Auto App\Tổng hợp\Position"  # Base folder path for VSP
