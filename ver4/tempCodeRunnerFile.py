...
if hasattr(sys, '_MEIPASS'):
    ...
    PID_SCRIPTS_FOLDER = os.path.join(sys._MEIPASS, 'Scripts', 'PID')  # Folder containing PID AutoLISP files
    TML_SCRIPTS_FOLDER = os.path.join(sys._MEIPASS, 'Scripts', 'TML')  # Folder containing TML AutoLISP files
    POSITION_SCRIPTS_FOLDER = os.path.join(sys._MEIPASS, 'Scripts', 'POSITION')  # Folder containing TML AutoLISP files
    ...
    PID_SCRIPTS_FOLDER = r"C:\Users\USER\Desktop\Auto App\Scripts\PID"  # Base folder path for VSP
    TML_SCRIPTS_FOLDER = r"C:\Users\USER\Desktop\Auto App\Scripts\TML"  # Base folder path for VSP
    POSITION_SCRIPTS_FOLDER = r"C:\Users\USER\Desktop\Auto App\Scripts\Position"  # Base folder path for VSP
