...
OutputBaseFilename=TrueTag_v4.1_Setup
Compression=lzma
...
Type: files; Name: "{app}\TRUETAG-v4.1.exe"

[Icons]
Name: "{autodesktop}\TrueTag v4.1"; Filename: "{app}\TRUETAG-v4.1.exe"; IconFilename: "{app}\logo.ico"; Tasks: desktopicon
...
begin
  ...
  Exec('taskkill', '/F /IM TRUETAG-v4.1.exe /T', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
  Result := True;
end;
